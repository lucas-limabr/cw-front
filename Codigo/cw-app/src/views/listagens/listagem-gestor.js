  ...
  async function excluir(id) {
    ...
    await axios
      ...
      .then(function (response) {
        mensagemSucesso(`Gestor excluído com sucesso!`);
        setDados(
          dados.filter((dado) => {
            return dado.id !== id;
          }),
      ...
      .catch(function (error) {
        mensagemErro(`Erro ao excluir o gestor`);
      });
  }
...
export default ListagemGestores;
